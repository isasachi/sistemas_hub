  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <details className="rounded-xl border border-white/[0.08] bg-white/[0.02] px-4 py-3">
        <summary className="text-[13px] font-semibold text-[#f5f5f5] cursor-pointer select-none">
          Afinar copy y etiquetas <span className="text-[#8a8a8a] font-normal">(opcional)</span>
        </summary>
