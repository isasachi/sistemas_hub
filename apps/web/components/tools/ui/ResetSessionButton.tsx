...
export function ResetSessionButton({
  ...
  return (
    <button
      ...
      className="flex items-center gap-1.5 text-[12px] font-medium text-[#a98c88] hover:text-[#f6f2eb] transition-colors cursor-pointer bg-transparent border-0 px-2 py-1 rounded-lg hover:bg-white/[0.05]"
    >
