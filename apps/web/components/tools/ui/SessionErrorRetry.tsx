...
export function SessionErrorRetry({ onRetry }: { onRetry: () => void }) {
  return (
    <div className="max-w-xl mx-auto w-full px-4 py-16 flex flex-col items-center gap-4 text-center">
      <p className="text-[14px] text-[#f5f5f5] font-semibold">No se pudo iniciar la sesión</p>
      <p className="text-[13px] text-[#bdbdbd]">Revisa tu conexión e inténtalo de nuevo.</p>
      <button
        onClick={onRetry}
