...
const EXTRAS_SYSTEM = [
  ...
  'simply omit that part of the description instead of guessing. Describe the containerType in SINGULAR form',
  'only, as ONE representative unit of the packaging, regardless of how many units are shown in the photograph —',
  'the quantity and composition of multiple units belongs in the composition field, not here. Never reuse the wording of this instruction\'s',
