...
export function buildTemplateInstruction(forensic: ForensicReport): string {
  return [
    ...
    'mismo orden, mismo número aproximado de palabras, misma puntuación, los mismos',
    'cambios de idea y las mismas repeticiones. Si el original repite una palabra o se',
    'corta a mitad de idea, la plantilla también. Si al leerla no se reconoce el guion',
    'de origen, marcaste de más.',
    '',
    ...
    '',
    '── CÓMO SE MARCA ──',
    'EL CORCHETE CUBRE EL DATO COMPLETO, no la primera palabra del dato. Si el original',
    'dice "hidratar las capas más profundas de la piel", el hueco es',
    '[Beneficio] = toda esa frase, NO "hidratar" con el resto colgando fuera: un suero',
    'antimanchas no hidrata capas profundas, así que ese resto se publicaría como una',
    'afirmación falsa sobre el producto del usuario.',
    '',
    ...
    'Lee la frase poniendo en el hueco un valor de OTRO producto cualquiera. Si lo que',
    'queda afirma algo falso sobre ese otro producto, el hueco es demasiado chico y',
    'tiene que crecer hasta que la frase sea cierta para los dos. Si en cambio deja de',
    'entenderse la frase, creciste de más.',
    '',
    '    "Lo que nos ayuda a [Beneficio] las capas más profundas de la piel"',
    '        → con un champú: "a limpiar las capas más profundas de la piel". FALSO.',
    '          El hueco tenía que cubrir la frase entera.',
    '    "de la marca [Marca]"',
    '        → con un champú: "de la marca Head & Shoulders". CIERTO. Está bien cortado.',
    '',
