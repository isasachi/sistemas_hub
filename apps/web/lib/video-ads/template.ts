...
export function buildTemplateInstruction(forensic: ForensicReport): string {
  return [
    ...
    '  [Categoría del producto]  [Beneficio]  [Mecanismo]  [Ingrediente]',
    '  [Característica]  [Objeción]  [Resultado]  [CTA]',
    '',
    'Esa lista es CERRADA. No inventes nombres nuevos. Si algo no encaja en ninguno de',
    'los doce, es señal de que no había que marcarlo. Un nombre inventado como',
    ...
    '',
    '    ORIGINAL: "Este es el serum antienvejecimiento de la marca Apivita"',
    '    MAL:      "[Este es el Producto]"   ← se tragó la oración',
    '    BIEN:     "Este es el [Producto] de la marca [Producto]"',
    '',
