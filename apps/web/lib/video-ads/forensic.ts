...
export function buildForensicInstruction(): string {
  return [
    ...
    '  - qué hace la mano libre mientras tanto, y qué SIGUE sosteniendo: una mano que',
    '    señala, saluda o toca la cara ya soltó lo que tenía, y eso hay que escribirlo',
    '    ("deja el frasco fuera de cuadro y señala con la izquierda"). Cada corte se',
    '    renderiza por separado y sin memoria del anterior, así que empieza diciendo qué',
    '    tiene cada mano ANTES del primer movimiento; si no, el generador le dibuja a la',
    '    persona una tercera mano para que le alcancen las dos que ya están ocupadas;',
