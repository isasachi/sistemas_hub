...
const PROMPT = [
  ...
  'Un ingrediente se representa por la MATERIA PRIMA de la que viene —la fruta, la raíz, la hoja,',
  'la semilla—, nunca por una versión procesada que se parezca a OTRO formato de producto: si el',
  'producto son gomitas, un prop de "vitamina C en polvo" o de cápsulas sueltas hace que la pieza',
  'entera se lea como un polvo o un blíster. Ese prop está prohibido aunque el ingrediente sí esté',
  'en la etiqueta. El único formato visible en la escena es el del producto.',
  '',
