...
Los tres suplementos se distinguen por la PROMESA, no por el envase: \`supplement_skin_female\` es el que promete BELLEZA visible (piel, cabello, uñas, colágeno); \`supplement_female\` es el resto del bienestar de la mujer —sueño, hormonas, ciclo, energía, hierro, ánimo—, o sea cuando el beneficio se SIENTE y no se ve en el espejo; \`supplement_male_performance\` es el equivalente masculino. Un suplemento que una mujer toma para dormir o para su energía diaria NO es de belleza.
