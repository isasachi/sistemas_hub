 ...
 * un mockup compuesto de una sola pasada (texto puro, sin refs adjuntas —
 * a diferencia del pipeline secuencial real logo→etiqueta→mockup de
 * `generation-prompts.ts`, aquí no hace falta encadenar artefactos: solo
 * queremos UNA foto representativa del estilo para la grilla del picker) y
 * los sube a Storage en `branding-refs/thumbnails/<styleId>.png` (bucket
 * `ad-uploads`, upsert). No borra los 12 thumbnails viejos.
 *
