...
- El creativo muestra que NO es un producto físico importable: servicios, cursos, eventos, apps, locales físicos ("visita nuestra tienda", "agenda tu cita").
...
- **D** — saturado (muchos competidores con volumen alto). Prioridad `descartado`, score < 30.
...
Para candidatos `descartado`, devuelve `[]`.
